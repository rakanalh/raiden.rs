...
use crate::{
	blockchain::{contracts::GasMetadata, proxies::transaction::Transaction},
	primitives::{BlockHash, ChannelIdentifier, SettleTimeout, TokenAddress, TokenAmount},
};

use super::{
	contract::{ParticipantDetails, TokenNetworkContract},
	transaction::{
		ChannelOpenTransaction, ChannelOpenTransactionParams, ChannelSetTotalDepositTransaction,
