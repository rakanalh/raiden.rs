...
pub(super) fn get_max_withdraw_amount(sender_state: &ChannelEndState, receiver_state: &ChannelEndState) -> TokenAmount {
...
pub(crate) fn get_lock(end_state: &ChannelEndState, secrethash: SecretHash) -> Option<HashTimeLockState> {
