...
pub(super) fn is_valid_signature(data: Bytes, signature: Signature, sender_address: Address) -> Result<(), String> {
...
pub(super) fn is_balance_proof_safe_for_onchain_operations(balance_proof: &BalanceProofState) -> bool {
    balance_proof
        .transferred_amount
...
pub(super) fn is_withdraw_expired(block_number: BlockNumber, expiration_threshold: BlockExpiration) -> bool {
