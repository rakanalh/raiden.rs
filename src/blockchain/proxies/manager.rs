...
impl ProxyManager {
    ...
    ) -> Result<TokenNetworkRegistryProxy<Http>, ContractError> {
        if !self
    ...
    pub fn token(&self, token_address: Address, account_address: Address) -> Result<TokenProxy<Http>, ContractError> {
    ...
    pub fn token_network(
        ...
        account_address: Address,
    ) -> Result<TokenNetworkProxy<Http>, ContractError> {
