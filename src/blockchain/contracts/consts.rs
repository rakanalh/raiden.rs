...
pub(crate) const DEPLOYMENT_KOVAN: &str = include_str!("data/deployment_kovan.json");
pub(crate) const DEPLOYMENT_GOERLI: &str = include_str!("data/deployment_goerli.json");
